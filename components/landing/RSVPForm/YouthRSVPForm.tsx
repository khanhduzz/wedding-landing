...
//       {/* Background Decor: Giấy kẻ caro tập vẽ */}
...
//         {/* Title Section: Phong cách tiêu đề báo tường */}
...
//         {/* Form Card: Một tờ phiếu khảo sát dán băng dính */}
//         <div className="relative max-w-2xl mx-auto">
//           {/* Băng dính giả ở 4 góc */}
...
//               {/* Phần chọn tham dự: Checkbox phong cách trắc nghiệm */}
...
//               <div className="flex items-center gap-8 py-6 bg-blue-50 border-4 border-blue-600 p-6 rounded-2xl relative">
...
//                       }))
//                     }
//                     className="w-10 h-10 border-4 border-black bg-white font-black text-xl active:translate-y-1 shadow-[4px_4px_0px_#000]"
//                   >
//                     -
//                   </button>
...
//               {/* Nút gửi phong cách Sticker */}
//               <div className="pt-8">
//                 <motion.button
//                   type="submit"
//                   whileHover={{ scale: 1.05, rotate: -2 }}
//                   whileTap={{ scale: 0.95 }}
//                   className="w-full bg-green-400 border-4 border-black py-5 shadow-[10px_10px_0px_#000] flex items-center justify-center gap-4 group transition-colors hover:bg-green-300"
//                 >
...
//                   className="bg-pink-100 border-4 border-pink-500 p-4 text-center text-pink-600 font-black uppercase tracking-tight"
//                 >
//                   ✨ {status} ✨
//                 </motion.div>
//               )}
