...
export default function WeddingInfoOrigin({ dict }: { dict: any }) {
  // Shortcut truy cập weddingInfo dict
  const info = dict.weddingInfo;

  // Đường dẫn ảnh cố định cho từng card theo index
